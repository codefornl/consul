...
ActiveRecord::Schema.define(version: 20190928034143) do
  ...
  add_index "budget_administrators", ["administrator_id"], name: "index_budget_administrators_on_administrator_id", using: :btree
  add_index "budget_administrators", ["budget_id"], name: "index_budget_administrators_on_budget_id", using: :btree
  ...
  add_index "budget_rol_assignments", ["budget_id"], name: "index_budget_rol_assignments_on_budget_id", using: :btree
  add_index "budget_rol_assignments", ["user_id"], name: "index_budget_rol_assignments_on_user_id", using: :btree
  ...
  add_index "budget_tracker_assignments", ["investment_id"], name: "index_budget_tracker_assignments_on_investment_id", using: :btree
  add_index "budget_tracker_assignments", ["tracker_id"], name: "index_budget_tracker_assignments_on_tracker_id", using: :btree
  ...
  add_index "budget_trackers", ["budget_id"], name: "index_budget_trackers_on_budget_id", using: :btree
  add_index "budget_trackers", ["tracker_id"], name: "index_budget_trackers_on_tracker_id", using: :btree
  ...
  add_index "budget_valuators", ["budget_id"], name: "index_budget_valuators_on_budget_id", using: :btree
  add_index "budget_valuators", ["valuator_id"], name: "index_budget_valuators_on_valuator_id", using: :btree
  ...
  add_index "download_settings", ["name_model", "name_field", "config"], name: "index_download_settings_on_name_model_and_name_field_and_config", unique: true, using: :btree
  ...
  add_index "local_census_records", ["document_number", "document_type"], name: "index_local_census_records_on_document_number_and_document_type", unique: true, using: :btree
  add_index "local_census_records", ["document_number"], name: "index_local_census_records_on_document_number", using: :btree
  ...
  add_index "poll_pair_answers", ["answer_left_id"], name: "index_poll_pair_answers_on_answer_left_id", using: :btree
  add_index "poll_pair_answers", ["answer_rigth_id"], name: "index_poll_pair_answers_on_answer_rigth_id", using: :btree
  add_index "poll_pair_answers", ["author_id"], name: "index_poll_pair_answers_on_author_id", using: :btree
  add_index "poll_pair_answers", ["question_id"], name: "index_poll_pair_answers_on_question_id", using: :btree
  ...
  add_index "reports", ["process_type", "process_id"], name: "index_reports_on_process_type_and_process_id", using: :btree
  ...
  add_index "votation_set_answers", ["author_id"], name: "index_votation_set_answers_on_author_id", using: :btree
  add_index "votation_set_answers", ["votation_type_id"], name: "index_votation_set_answers_on_votation_type_id", using: :btree
